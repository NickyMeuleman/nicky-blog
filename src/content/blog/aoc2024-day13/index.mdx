...
<Aside variant="info">
  I am inexperienced at writing math syntax, so ignore the bracketed number on
  the right, and pretend there is a `-` sign in front of the horizontal line.
</Aside>

$$
\begin{align}
a_n*a_x*b_y &+ b_n*b_x*b_y &=& p_x \\
a_n*a_y*b_x &+ b_n*b_y*b_x &=& p_y \\
\hline \\
a_n * (a_x * b_y - a_y * b_x) &+ 0 &=& p_x - p_y
\end{align}
$$
...
$$
a_n = \frac{p_x - p_y}{a_x * b_y - a_y * b_x}
$$
