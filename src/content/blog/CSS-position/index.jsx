...
const AbsoluteChart = () => {
  ...
  return (
    <svg
      ...
      className="h-auto max-w-full [&_path]:stroke-watermarkBg [&_rect]:fill-background [&_text]:fill-text"
    >
      <rect
        x="0"
        y="0"
...
const RelativeDemo = () => {
  ...
  const boxClasses =
    "grid place-items-center aspect-square rounded-sm border-4 border-black/30 text-5xl";
  const codeStr = `
.two {
  position: relative;
${top != null ? `  top: ${top}px;\n` : ""}${
  ...
  return (
    <div>
      <div className="grid grid-cols-[repeat(3,minmax(100px,1fr))]">
        <div className={`bg-mutedBackground ${boxClasses}`}>1</div>
        <div
          className={`relative bg-primary ${boxClasses}`}
          style={{
            top: top && `${top}px`,
        ...
        <div className={`bg-mutedBackground ${boxClasses}`}>3</div>
      </div>
      <div className="relative mt-4 grid grid-cols-1 gap-4 bg-background/50 backdrop-blur-sm lg:grid-cols-2">
        <Slider
          labelText="top"
          idPrepend="relative"
          val={top}
...
${top != null ? `  top: ${top}px;\n` : ""}${
  ...
  return (
    <div>
      <div className="relative grid grid-cols-[repeat(3,minmax(100px,1fr))]">
        <div className={`bg-mutedBackground ${boxClasses}`}>1</div>
        <div
          className={`absolute aspect-[unset] bg-primary ${boxClasses}`}
          style={{
            top: top && `${top}px`,
            right: right && `${right}px`,
            left: left && `${left}px`,
...
${top != null ? `  top: ${top}px;\n` : ""}}`;
  return (
    <div>
      <div className="max-h-[min(500px,50vh)] overflow-y-scroll border border-watermarkBg p-2 [&::-webkit-scrollbar-thumb:hover:active]:bg-text [&::-webkit-scrollbar-thumb:hover]:bg-mutedText [&::-webkit-scrollbar-thumb]:min-h-[58px] [&::-webkit-scrollbar-thumb]:rounded-lg [&::-webkit-scrollbar-thumb]:border-4 [&::-webkit-scrollbar-thumb]:border-background [&::-webkit-scrollbar-thumb]:bg-mutedTextBg [&::-webkit-scrollbar]:w-2">
        <div className="overflow-[none] grid grid-cols-[repeat(3,minmax(100px,1fr))]">
          <div className="col-span-full row-start-1 mb-2">
          ...
          <div className={`bg-mutedBackground ${boxClasses}`}>1</div>
          <div
            className={`sticky bg-primary will-change-[top] ${boxClasses}`}
            style={{
              top: top && `${top}px`,
            }}
          >
      ...
      <div className="relative grid grid-cols-1 gap-4 bg-background/50 backdrop-blur-sm lg:grid-cols-2">
        <Slider
          marginTop={true}
          labelText="top"
          idPrepend="sticky"
