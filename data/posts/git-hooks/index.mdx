...
Along with increased clarity, using a consistent commit message format has [many](https://www.conventionalcommits.org/en/v1.0.0-beta.2/#why-use-conventional-commits) [benifits](https://slides.com/marionebl/the-perks-of-committing-with-conventions#/).
...
<Aside>
  An alternative to the commitlint promp is
