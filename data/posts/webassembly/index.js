...
const NativeCompiling = () => {
  return (
    <svg
      ...
      sx={{
        "--x86": (t) => t.colors.mutedPrimary,
        "--ARM": (t) => t.colors.danger,
        color: "mutedPrimary",
        maxWidth: "100%",
        height: "auto",
        rect: {
...
const WASMCompiling = () => {
  return (
    <svg
      ...
      sx={{
        "--WASM": (t) => t.colors.mutedBackground,
        "--x86": (t) => t.colors.mutedPrimary,
        "--ARM": (t) => t.colors.danger,
        color: "mutedPrimary",
        maxWidth: "100%",
...
const Portability = () => {
  return (
    <div sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
      <div sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
        <p sx={{ margin: 0 }}>Compiling to native</p>
        <NativeCompiling />
      </div>
      <div sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
        <p sx={{ margin: 0 }}>Compiling to WASM</p>
        <WASMCompiling />
      </div>
    </div>
  );
...
const Glue = () => {
  return (
    <svg
      ...
      sx={{
        "--runtime": (t) => t.colors.mutedBackground,
        "--glue": (t) => t.colors.danger,
        color: "mutedPrimary",
        maxWidth: "100%",
        height: "auto",
        rect: {
