...
The concepts of concurrency and parallelism are used to fully use the computational power of a [<abbr title="Central Processing Unit" style="text-decoration: none;">CPU</abbr>](https://en.wikipedia.org/wiki/Central_processing_unit).
