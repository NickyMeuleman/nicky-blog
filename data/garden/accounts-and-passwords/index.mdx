...
This makes it harder for shady sites to sell your emailadress and spam you.
...
<YouTube youTubeId="pmfjt2PPuVA" />

## Opinions and what I use

As a password manager I use [KeePassXC](https://keepassxc.org/).
...
I also prefer not using them because I never seem to remember which one I used again.
...
Facebook, I avoid because... They have a [less than sterling](https://www.vice.com/en_us/article/akz7qa/facebook-finally-agreed-to-a-civil-rights-audit-and-surprise-surprise-it-failed) [trackrecord](https://www.businessinsider.com/oculus-vr-users-log-into-facebook-2020-8) [when it](https://techcrunch.com/2018/04/05/zuckerberg-deleted-messages) [comes](https://www.washingtonpost.com/news/the-switch/wp/2018/04/04/facebook-said-the-personal-data-of-most-its-2-billion-users-has-been-collected-and-shared-with-outsiders/) [to](https://www.nytimes.com/interactive/2018/06/03/technology/facebook-device-partners-users-friends-data.html) [privacy](https://www.nytimes.com/2018/04/04/us/politics/cambridge-analytica-scandal-fallout.html).
...
Apple is going to [force](https://www.theverge.com/2019/6/3/18651344/wwdc-2019-apple-force-ios-developers-sign-in-third-party) anyone on iOS using other single sign on services to also implement theirs.
Oh, Apple.
